...
I [!UICONTROL In-App Messaging] kanalen kan du visa ett meddelande när användaren är aktiv i mobilprogrammet. This channel requires mobile applications to be integrated with [!UICONTROL Adobe Experience Platform SDK].
...
1. Verify that your **user** has the necessary **permissions** in Adobe Campaign Standard and [!UICONTROL Launch].
   ...
   1. Kontrollera att IMS-användaren är en del av [!UICONTROL Standard User] och [!UICONTROL Administrator] grupperna i Adobe Campaign Standard.\
