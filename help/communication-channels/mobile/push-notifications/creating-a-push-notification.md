...
* **[!UICONTROL Send push notification to Campaign profiles]**: Gör att du kan ange Adobe Campaign som mål för de CRM-profiler som har prenumererat på ditt mobilprogram och som har valt att ta emot [!UICONTROL push notifications]. Du kan infoga anpassningsfält i ditt [!UICONTROL push notification]dokument, t.ex. mottagarens förnamn.
